...
(function () {
  ...
  /* RETURN เพิ่มตามที่ผู้ใช้ยืนยันว่ามีคลังนี้จริงแล้ว ไม่ใช่เดาเอง
     ขึ้นทั้งใบเบิกและใบโอน เพราะเป็นคลังจริง ไม่ใช่ตัวเลือกเฉพาะใบใดใบหนึ่ง */
  var WAREHOUSES = ['', 'NEW WH-2', 'QA', 'RACK', 'RETURN'];
